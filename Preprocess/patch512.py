# -*- coding: utf-8 -*-
"""
Created on Wed Feb  3 14:38:12 2021
...
# make patches300 dir
all_patches256_dir = "D:/proje/ICIAR2018_BACH_Challenge/patch512/"
...
for index, row in image_label_df.iterrows():
    ...
    for i, patch in enumerate(non_bkgd_patches):
        ...
        f_name = "D:/proje/ICIAR2018_BACH_Challenge/patch512/" + row['class'] + "/" + os.path.splitext(row['tif'])[0] + "_" + str(i).zfill(3) + ".tif"
        im.save(f_name)
