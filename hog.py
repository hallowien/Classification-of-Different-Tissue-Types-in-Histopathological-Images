# -*- coding: utf-8 -*-
"""
Created on Tue Feb  2 19:11:45 2021
...
train_path = 'D:/proje/ICIAR2018_BACH_Challenge/patch256_thresh110/'

def hog_feature(image):
    gray= cv2.cvtColor(image,cv2.COLOR_BGR2GRAY)
    fd,hog_img=hog(gray,orientations=8,pixels_per_cell=(128,128),cells_per_block=(2,2),block_norm='L2',visualize=True)
    return fd,hog_img
